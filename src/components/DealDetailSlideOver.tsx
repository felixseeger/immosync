    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-xl glass rounded-none rounded-l-2xl border-l border-gray-200/50 dark:border-white/10 shadow-2xl flex flex-col max-h-full overflow-hidden"

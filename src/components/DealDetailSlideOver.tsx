    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-xl bg-app-light dark:bg-app-dark rounded-none rounded-l-2xl border-l border-gray-200 dark:border-zinc-800 shadow-2xl flex flex-col max-h-full overflow-hidden"

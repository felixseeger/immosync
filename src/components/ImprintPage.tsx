  ...
  return (
    <div className="min-h-screen w-full relative flex flex-col bg-app-light dark:bg-app-dark">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Imprint</h1>
        <div className="prose prose-invert max-w-none text-gray-600 dark:text-zinc-400 space-y-4">
          <p><strong>ImmoSync</strong></p>
          <p>© 2026 Felix Seeger</p>
          <p>Contact and legal details can be added here.</p>
        </div>
      </div>
    </div>
  );
